def ex2():
    ...
    PATH = "/Users/elber/Documents/COMP 4948 - Datasets/small_cats_and_dogs/"
    ...
    def create_model(X_train, y_train, X_test, y_test):
        ...
        print("Output shape after Conv2D: ", model.output_shape)
        model.add(MaxPool2D(pool_size=(2, 2), strides=(2, 2)))
        print("Output shape after MaxPool2D: ", model.output_shape)
    ...
    confusion_matrix = pd.crosstab(
        y_test, predictionArray, rownames=["Actual"], colnames=["Predicted"]
    )
...
def ex3():
    ...
    PATH = "/Users/elber/Documents/COMP 4948 - Datasets/small_cats_and_dogs_and_octopi/"
